...
namespace Cashly.Domain.Tests.ValueObjects
{
    public class ValueObjectCashUnitTests
    {
        ...
        {
            // ACT 
            Action action = () => CashBuilder.BuildValidCash();
        ...
        {
            // ACT 
            Action action = () => CashBuilder.BuildInvalidCash();
        ...
        public void SubtractionOperator_WithTwoInvalidValues_ResultInvalidOperationException()
        {
            ...
            // ASSERT
            action.ShouldThrow<DomainExceptionValidation>().Message.ShouldBe("Result of the operation must be greater than 0");
        }
