...
namespace Cashly.Domain.Tests.ValueObjects
{
    public class ValueObjectNameUnitTests
    {
        ...
        {
            Action action = () => NameBuilder.BuildValidName();
        ...
        {
            Action action = () => NameBuilder.BuildInvalidNameWithShortLength();
        ...
        {
            Action action = () => NameBuilder.BuildInvalidNameWithNullOrWhiteSpaceValue();
